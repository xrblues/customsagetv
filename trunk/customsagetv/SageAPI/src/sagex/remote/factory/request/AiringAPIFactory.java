...
public class AiringAPIFactory {
	public static RemoteRequest createRequest(String context, String command, String[] parameters) {
		...
		if (command.equals("AddAiringDetailed")) {
			return sagex.remote.xmlrpc.RequestHelper.createRequest(context, "AddAiringDetailed", parameters, java.lang.String.class, int.class, long.class, long.class, int.class, int.class, java.lang.String.class, boolean.class, boolean.class, boolean.class, boolean.class, boolean.class,
