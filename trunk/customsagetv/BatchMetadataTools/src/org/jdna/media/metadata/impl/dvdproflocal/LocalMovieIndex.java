...
public class LocalMovieIndex implements IDVDProfMovieNodeVisitor {
    ...
    public List<IMediaSearchResult> searchTitle(String title) throws Exception {
        ...
        for (int i = 0; i < l; i++) {
            ...
            results.add(new MediaSearchResult(LocalDVDProfMetaDataProvider.PROVIDER_ID, id, new MetadataID(LocalDVDProfMetaDataProvider.PROVIDER_ID, id), name, date, score));
        }
