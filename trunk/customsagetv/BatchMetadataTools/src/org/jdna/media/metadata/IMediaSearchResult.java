...
public interface IMediaSearchResult {
    ...
    public static final String[] SEARCH_TYPE_NAMES         = new String[] { "Unknown", "Exact Match", "Partial Match", "Popular Match" };
    ...
    /**
     * id of the this result. Should have meaning to the provider that created
     * the result.
     * 
     * @return
     */
