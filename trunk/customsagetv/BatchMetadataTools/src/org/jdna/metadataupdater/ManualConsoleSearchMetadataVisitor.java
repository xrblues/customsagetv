...
public class ManualConsoleSearchMetadataVisitor extends AutomaticUpdateMetadataVisitor {
	...
	public ManualConsoleSearchMetadataVisitor(String providerId, boolean aggressive, boolean overwriteThumbs, IMediaResourceVisitor updatedVisitor, IMediaResourceVisitor notFoundHandler) {
		super(providerId, aggressive, overwriteThumbs, updatedVisitor, notFoundHandler);
	}

	public ManualConsoleSearchMetadataVisitor(String providerId, boolean aggressive, boolean overwriteThumbs, IMediaResourceVisitor updatedVisitor, IMediaResourceVisitor notFoundHandler, int displaySize) {
		super(providerId, aggressive, overwriteThumbs, updatedVisitor, notFoundHandler);
	...
	protected void handleNotFoundResults(IMediaFile file, String title, List<IMediaSearchResult> results) {
		...
		try {
			if ("q".equalsIgnoreCase(data)) {
				...
				file.updateMetadata(md, isOverwriteThumbnailsEnabled());
