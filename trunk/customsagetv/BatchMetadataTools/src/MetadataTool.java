...
/**
 * Simple Launcher that automatically builds up the Classpath and invokes the main class.
 * This negates the need to write a bat/cmd/sh script for each platform.
 * 
 * You invoke it by
 * <pre>
