...
public class MediaFolder extends AbstractMediaResource implements IMediaFolder {
    ...
    public List<IMediaResource> members() {
        ...
        if (now - lastUpdate > updateDelay) {
            ...
            // iterate through the resources and build up a list media resources
            // for this folder
            ...
            try {
                ...
                // probably a list state exception... ignore... gc should clean
                // up.
            }
        }
    ...
    /**
     * Return s child resource of this folder resource, or null if the doesn't
     * exist.
     * 
     * The path must be a url unix style path. ie, use "/" and not backslash.
     * Paths cannot start with "/" or a ".". If you do pass paths that start
     * with "/" or ".", then a runtime exception will be thrown.
     * 
     * @param path
