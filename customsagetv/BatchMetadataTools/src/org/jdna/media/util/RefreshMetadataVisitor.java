...
public class RefreshMetadataVisitor implements IMediaResourceVisitor {
	...
	public RefreshMetadataVisitor(boolean overwriteThumbs, IMediaResourceVisitor onUpdateVisitor, IMediaResourceVisitor onSkipMediaResourceVisitor) {
	...
	public void visit(IMediaResource resource) {
		if (resource.getType() == IMediaFile.TYPE_FILE) {
			...
			if (md.getProviderDataUrl() != null && md.getProviderId() != null) {
				...
				resource.updateMetadata(updated, overwriteThumbnails);
