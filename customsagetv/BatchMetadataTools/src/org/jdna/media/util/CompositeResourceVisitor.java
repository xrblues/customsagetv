...
/**
 * Resource Visitor that can chain other resource visitors. If you need to
 * execute more visitors per item, then keep chaining them, such as, new
 * CompositeResourceVistor(v1, new CompositeResourceVisitor(v2,v3));
 * 
 * @author seans
 * 
 */
