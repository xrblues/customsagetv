...
/**
 * Simple Name based exclude filter.  Pass a comma separated list of dirs or String array.  
 * For each dir that is passed, it will check for a name match.  If it matches, then the dir is excluded.
 * 
 * @author seans
 *
 */
