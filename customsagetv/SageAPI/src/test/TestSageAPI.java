...
/**
 * To enable the remote sage api, you need to add sagex.remote.SageRPCServerRunner to the server property, load_at_startup_runnable_classes
 * 
...
public class TestSageAPI {
	public static void main(String args[]) throws Exception {
		...
		// lets find all sage servers on the network (ie, what the extenders do when they start up)
