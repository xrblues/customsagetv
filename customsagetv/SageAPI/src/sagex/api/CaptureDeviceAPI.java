 ...
 * href='http://download.sage.tv/api/sage/api/CaptureDeviceAPI.html'>CaptureDeviceAPI</a>
...
public class CaptureDeviceAPI {
	 ...
	 * 
	 * Returns: the names of all of the CaptureDevices in the system that SageTV
	 * can use
	 */
	 ...
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Returns: all of
	 * the CaptureDeviceInputs for the specified CaptureDevice.
	 */
	...
	/**
	 * Returns all of the CaptureDeviceInputs that are currently configured for
	 * use by SageTV.
	 * 
	 * Returns: the names of all of the CaptureDeviceInputs that are currently
	 * configured for use by SageTV.
	 */
	...
	/**
	 * Returns whether or not a CaptureDevice is functioning (i.e. the device is
	 * offline)
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Returns: false
	 * if a CaptureDevice is NOT functioning (i.e. the device is offline),
	 * otherwise true
	 */
	 ...
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Returns: true if
	 * the specified CaptureDevice is a Network Encoder
	 */
	...
	/**
	 * Returns all of the CaptureDevices that are currently configured for use
	 * by SageTV
	 * 
	 * Returns: all of the CaptureDevices that are currently configured for use
	 * by SageTV
	...
	/**
	 * Returns true if the CaptureDevice is currently under control of a client
	 * who is (or was) watching live TV
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Returns: true if
	 * the specified CaptureDevice is currently under control of a client who is
	 * watching live/delayed TV
	 */
	...
	/**
	 * Returns a CaptureDeviceInput that corresponds to using the tuner input on
	 * the CaptureDevice locked to a certain channel. For example, using the RF
	 * connection from your cable box to the capture card on channel 3 would
	 * required adding a new input this way.
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice to add the new
	 * input to RFChannel- the channel to tune to for this RF input Returns: the
	 * name of the CaptureDeviceInput that was created which will act as an RF
	 * channel input
	 */
	 ...
	 * 
	 * Returns: the name of the last CaptureDevice that was accessed by SageTV.
	 */
	...
	/**
	 * Returns the last CaptureDeviceInput that was used by SageTV on the given
	 * CaptureDevice
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Returns: the
	 * name of the last CaptureDeviceInput that was used by SageTV on the given
	 * CaptureDevice
	 */
	 ...
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Returns: the
	 * file that is currently being recorded by the specified capture device
	 */
	 ...
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Returns: the
	 * recording qualities which are supported by the specified CaptureDevice
	 */
	 ...
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Returns: the
	 * default recording quality for the specified CaptureDevice; if there is no
	 * default quality set it will return the empty string
	 */
	 ...
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Quality- the
	 * default quality setting to use for the specified capture device, use null
	 * or the empty string to clear the setting
	 */
	 ...
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice AudioSource- the
	 * name of the audio capture source, should be one of the values
	 * fromGetAudioCaptureSources()
	 */
	 ...
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Returns: the
	 * name of the audio capture source for the specified CaptureDevice; the
	 * empty string is returned if there is no separate audio capture source
	 * (i.e. multiplexed capture or video only capture)
	 */
	...
	/**
	 * Returns an array of all the audio capture sources in the system, used
	 * withSetCaptureDeviceAudioSource(CaptureDevice, AudioSource)
	 * 
	 * 
	 * Returns: an array of all the audio capture sources in the system
	 */
	 ...
	 * 
	 * Parameters: CaptureDevice- the name of the CaptureDevice Returns: true if
	 * the specified CaptureDevice is a hardware encoder
	 */
