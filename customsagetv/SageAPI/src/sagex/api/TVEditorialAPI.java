 ...
 * href='http://download.sage.tv/api/sage/api/TVEditorialAPI.html'>TVEditorialAPI</a>
 * This Generated API is not Affiliated with SageTV. It is user contributed.
 */
public class TVEditorialAPI {
	/**
	 * Returns a list of all of the 'TV Editorials' which are stories about TV
	 * shows
	 * 
	 * Returns: a list of all of the 'TV Editorials' Since: 5.1
	 */
	 ...
	 * 
	 * Parameters: TVEditorial- the TVEditorial object Returns: the title for
	 * the specified TVEditorial Since: 5.1
	 */
	 ...
	 * 
	 * Parameters: TVEditorial- the TVEditorial object Returns: the Show for the
	 * specified TVEditorial Since: 5.1
	 */
	 ...
	 * 
	 * Parameters: TVEditorial- the TVEditorial object Returns: the text for the
	 * specified TVEditorial Since: 5.1
	 */
	...
	/**
	 * Returns a String representing the airing date for the content the
	 * editorial is about
	 * 
	 * Parameters: TVEditorial- the TVEditorial object Returns: a String
	 * representing the airing date for the content the editorial is about
	 * Since: 5.1
	 */
	 ...
	 * 
	 * Parameters: TVEditorial- the TVEditorial object Returns: the network that
	 * the Show for this editorial is broadcast on Since: 5.1
	 */
	...
	/**
	 * Returns true if the specified editorial has an image that corresponds to
	 * it
	 * 
	 * Parameters: TVEditorial- the TVEditorial object Returns: true if the
	 * specified editorial has an image that corresponds to it, false otherwise
	 * Since: 5.1
	 */
	 ...
	 * 
	 * Parameters: TVEditorial- the TVEditorial object Returns: the image that
	 * corresponds to this editorial if there is one Since: 5.1
	 */
