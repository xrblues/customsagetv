...
public class ConsoleSageAPIProvider implements ISageAPIProvider {
    private static final Logger log      = Logger.getLogger(ConsoleSageAPIProvider.class);
    private Properties          props    = new Properties();
    private ISageAPIProvider remoteAPI = null;
    private boolean remoteAPIEnabled = false;

    public ConsoleSageAPIProvider() {
    ...
    public String toString() {
        return this.getClass().getName() + "[DVB Network Encoder Command Line Impl]";
    }
}
